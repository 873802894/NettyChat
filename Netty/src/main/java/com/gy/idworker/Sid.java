...
import com.gy.idworker.strategy.DefaultWorkerIdStrategy;
...
public class Sid {
    ...
    private static final DefaultWorkerIdStrategy defaultWorkerIdStrategy = new DefaultWorkerIdStrategy();
